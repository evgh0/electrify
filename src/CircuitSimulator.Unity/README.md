...
`com.evgh.circuit-simulator` is a Unity 6 package that maps scene components to an embedded realtime circuit model and exposes voltage, current, and power readings without exposing MNA data.
