...
internal interface IComponentState
{
}

/// <summary>Committed backward-Euler history for a capacitor.</summary>
internal sealed record CapacitorState(double PreviousVoltage, double PreviousCurrent) : IComponentState;

/// <summary>Committed backward-Euler history for an inductor.</summary>
internal sealed record InductorState(double PreviousCurrent) : IComponentState;
